...
const Page = () => {
  ...
  return (
    <div className="relative h-dvh w-dvw saturate-0 font-serif z-10 overflow-auto gradient-background">
      ...
      <div
        ref={containerRef}
        className="relative w-full flex items-center justify-center p-4 sm:p-6"
      >
        <ShineBorder
          color={[
            'var(--shine-color-1)',
        ...
        >
          <div className="backdrop-blur-md bg-card/90 min-w-[99.9%] rounded-2xl shadow-2xl transition-colors duration-300">
            <div className="flex flex-col lg:flex-row items-center justify-between p-4 sm:p-6 lg:p-8 gap-6 lg:gap-8 overflow-auto">
              {/* Left side - Form */}
              <div
                ref={formRef}
                  ...
                  <div className="space-y-4 lg:space-y-6">
                    ...
                    <div className="flex flex-col items-center lg:items-start space-y-4">
                      <div className="feature-item flex items-center gap-3">
                        <div className="p-2 rounded-full feature-amber">
                      ...
                      <div className="feature-item flex items-center gap-3">
                        <div className="p-2 rounded-full feature-yellow">
                          <div className="w-5 h-5">💳</div>
                        </div>
                        <p className="text-sm lg:text-base text-foreground">
