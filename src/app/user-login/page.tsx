            ...
            <div className="flex flex-col lg:flex-row items-center justify-between p-4 sm:p-6 lg:p-8 gap-6 lg:gap-8 max-h-[85vh] overflow-auto">
              ...
              >
                <div className="lg:hidden mb-6 text-center">
                  <h2 className="heading-text text-2xl sm:text-3xl font-bold text-gray-800 dark:text-gray-100 mb-3">
                    ByteBites
                  </h2>
                  <p className="desc-text text-sm sm:text-base text-gray-600 dark:text-gray-400">
              ...
              <div
                ref={contentRef}
                className="w-full lg:w-1/2 lg:border-l lg:border-gray-100 dark:lg:border-gray-800 lg:pl-8 flex items-center justify-center"
                style={{ height: "500px" }}
              >
                <div className="text-center">
                  ...
                  <div className="space-y-4 lg:space-y-6">
                    <p className="desc-text text-base lg:text-lg text-gray-600 dark:text-gray-400 leading-relaxed">
                    ...
                    <div className="flex flex-col items-center lg:items-start space-y-4">
                      <div className="feature-item flex items-center gap-3">
                        <div className="feature-purple p-2 rounded-full">
                      ...
                      <div className="feature-item flex items-center gap-3">
                        <div className="feature-pink p-2 rounded-full">
                      ...
                      <div className="feature-item flex items-center gap-3">
                        <div className="feature-orange p-2 rounded-full">
                          <div className="w-5 h-5">💳</div>
                        </div>
                        <p className="text-sm lg:text-base text-gray-700 dark:text-gray-300">
                    ...
                    <blockquote className="quote-text p-3 border-l-4 border-gradient-to-b from-purple-400 to-pink-400 bg-gray-50 dark:bg-gray-800 rounded-r-lg">
                      <p className="text-base lg:text-lg italic text-gray-700 dark:text-gray-300">
